...
out_dir = os.path.join(BASE_DIR, "results/FinQABench/")
finqa_task.save_results(output_dir=out_dir)
print(f"Saved results to {out_dir}/FinQABench/results.csv")

# === Step 7: Evaluate ===
qrels_path = os.path.join(BASE_DIR, "dataset/FinQABench/FinQABench_qrels.tsv")
...
print(f"FinQABench Dual-Dense + BM25 + BGE rerank nDCG@10: {ndcg['NDCG@10']:.4f}")
